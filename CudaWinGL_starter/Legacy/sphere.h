...
public:
    spheres()
    {
        ...
        //        vec3 _center(a + rand01(), rand01() * 16.0 + 0.2, b + rand01());
        //        if (choose_mat < 0.3f) {
        //            center[idx] = _center;
        //            radius[idx] = 0.2;
        ...
        //        //    radius[idx] = 0.2;
        //        //    albedo[idx] = vec3(0.5f * (1.0f + rand01()), 0.5f * (1.0f + rand01()), 0.5f * (1.0f + rand01()));
        //        //    //albedo[idx] = vec3(1, 1, 1);
        //        //    ref_idx[idx] = 1.05f;//  rand01(); //1.5;
        //        //    mat_type[idx] = 3;
        //        //    idx++;
        //        //}
        //    }
        ...
        //radius[idx] = 1;
        //albedo[idx] = vec3(1, 1, 1);// vec3(0.5f * (1.0f + rand01()), 0.5f * (1.0f + rand01()), 0.5f * (1.0f + rand01()));
        //ref_idx[idx] = 1.05;
        //mat_type[idx] = 3;
        //idx++;
        ...
        /*int idx = 1;
        center[idx] = vec3(-3.5, 1, 0);
        radius[idx] = 1;
        albedo[idx] = vec3(0.8, 0.8, 0.8);
        fuzz[idx] = 0.5f;
        ref_idx[idx] = 1.8f;
        mat_type[idx] = METAL;
        ...
        center[idx] = vec3(0, -1000.0, -1);
        radius[idx] = 1000;
        albedo[idx] = vec3(0.678, 0.847, 0.902);
        mat_type[idx] = 1;
        list_size = 2;*/
